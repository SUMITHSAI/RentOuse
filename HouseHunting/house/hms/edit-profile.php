...
$sql=mysqli_query($con,"Update tenants set fullName='$fname',address='$address',city='$city',gender='$gender' where id='".$_SESSION['id']."'");
if($sql)
{
...
<html lang="en">
	<head>
		<title>Buyer&Tenant | Edit Profile</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Buyer&Tenant | Edit Profile</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
...
<?php if($msg) { echo htmlentities($msg);}?> </h5>
									...
									<?php 
$sql=mysqli_query($con,"select * from tenants where id='".$_SESSION['id']."'");
