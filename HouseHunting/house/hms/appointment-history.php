...
<html lang="en">
	<head>
		<title>Buyer&Tenant | Appointment History</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Buyer&Tenant Appointment History</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th class="hidden-xs">Seller Name</th>
												<th>Category</th>
												<th>Pricing</th>
...
$sql=mysqli_query($con,"select sellers.sellerName as selname,house_appointment.*  from house_appointment join sellers on sellers.id=house_appointment.sellerId where house_appointment.buyerId='".$_SESSION['id']."'");
$cnt=1;
...
?>
											...
											<tr>
												...
												<td class="hidden-xs"><?php echo $row['selname'];?></td>
