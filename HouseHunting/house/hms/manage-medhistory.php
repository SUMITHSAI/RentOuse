...
<html lang="en">
	<head>
		<title>Reg Users | View Buyer&Tenant History</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Buyer&Tenant | Record</h1>
</div>
<ol class="breadcrumb">
<li>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">View <span class="text-bold"> Record</span></h5>
	
<table class="table table-hover" id="sample-table-1">
<thead>
<tr>
<th class="center">#</th>
<th>Buyer or User Name</th>
